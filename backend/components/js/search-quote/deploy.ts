...
// 组件标记
const startMark = '/* Sun-Panel-Helper JS Start: search-quote */'
const endMark = '/* Sun-Panel-Helper JS End: search-quote */'
...
export async function deploy(js: string): Promise<void> {
  try {
    ...
    const currentIndex = order.indexOf('search-quote');
...
(function() {
    try {
        ...
        console.error('[Sun-Panel-Helper] Error in search-quote:', e);
    }
})();`;
