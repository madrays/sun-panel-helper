...
// 组件标记
const startMark = '/* Sun-Panel-Helper JS Start: maxkb-ai */';
const endMark = '/* Sun-Panel-Helper JS End: maxkb-ai */';
...
export async function deploy(js: string): Promise<void> {
  try {
    ...
    const currentIndex = order.indexOf('maxkb-ai');
...
(function() {
    try {
        ...
        console.error('[Sun-Panel-Helper] Error in maxkb-ai:', e);
    }
})();`;
