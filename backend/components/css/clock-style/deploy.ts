...
// 组件标记
const startMark = '/* Sun-Panel-Helper CSS Start: clock-style */'
const endMark = '/* Sun-Panel-Helper CSS End: clock-style */'
...
export async function deploy(css: string): Promise<void> {
  try {
    ...
    const currentIndex = order.indexOf('clock-style');
