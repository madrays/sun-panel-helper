<template>
  <div class="widget-card" @click="$emit('click')">
      ...
      <div class="preview-area">
        <div class="tr-preview">
          ...
          <div class="tr-header">
            ...
            <span class="tr-title">Transmission下载器</span>
            <span class="tr-badge online">在线</span>
          </div>
          
          <!-- 内容区域 -->
          <div class="tr-content">
            <!-- 速度显示区域 -->
            <div class="tr-speed-row">
              <div class="tr-item download">
                <div class="tr-label">下载速度</div>
                <div class="tr-value download-value">3.5 MB/s</div>
              </div>
              
              <div class="tr-item upload">
                <div class="tr-label">上传速度</div>
                <div class="tr-value upload-value">1.2 MB/s</div>
              </div>
            </div>
            ...
            <div class="tr-stats-grid">
              <div class="tr-item">
                ...
                <div class="tr-value">5</div>
              </div>
              <div class="tr-item">
                <div class="tr-label">活跃</div>
                <div class="tr-value">8</div>
              </div>
              <div class="tr-item">
                <div class="tr-label">暂停</div>
                <div class="tr-value">3</div>
              </div>
              <div class="tr-item">
                <div class="tr-label">总数</div>
                <div class="tr-value">12</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="info-section">
      <h3>Transmission下载器状态</h3>
      <p>实时监控Transmission下载器状态，支持多个下载器和自定义显示项</p>
      <div class="tags">
